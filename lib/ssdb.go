...
func ConnectSSDB(ip string, port int) (*SSDBClient, error) {
...
func (c *SSDBClient) Do(args ...interface{}) ([]string, error) {
	err := c.send(args)
	if err != nil {
		return nil, err
	}
...
func (c *SSDBClient) Recv() ([]string, error) {
	return c.recv()
}
...
func (c *SSDBClient) parse() []string {
	resp := []string{}
